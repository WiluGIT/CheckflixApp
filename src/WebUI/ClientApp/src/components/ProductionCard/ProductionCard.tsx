...
const ProductionCard: React.FC<ProductionCardPropsType> = ({ production }) => {
    return (
        <div className="card mx-auto w-[200px] duration-300 hover:-translate-y-1 mt-1">
            ...
            <figure className="">
                <img src={!production.isMock ? production.poster ? `https://image.tmdb.org/t/p/w500/${production.poster}` : "https://image.tmdb.org/t/p/w500/vgpXmVaVyUL7GGiDeiK1mKEKzcX.jpg" : blankCard} className="rounded-lg shadow-lg" />
            </figure>
        </div>
    );
}
